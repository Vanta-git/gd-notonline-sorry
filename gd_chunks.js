(function () {
  ...
  var GD_ASSET_BASE = 'https://cdn.jsdelivr.net/gh/Vanta-git/gd-notonline-sorry@main/';
  ...
  function findAsset(input) {
    ...
    try {
      var nameMatch = /(?:^|\/)(gd_web\.(wasm|data))$/.exec(raw);

      if (nameMatch) {
        url = new URL(
          GD_ASSET_BASE + 'gd_web.' + nameMatch[2]
        );
      } else {
